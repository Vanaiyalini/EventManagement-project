...
<div id="details">
    <h1>Delete Admin Profile</h1>
    <form action="adminDelete" method="post">
        ID: <input type="text" name="aID" value="<%= request.getParameter("id") %>" readonly> <br><br>
        Name: <input type="text" name="aName" value="<%= request.getParameter("name") %>" readonly> <br><br>
        Role: <input type="text" name="aRole" value="<%= request.getParameter("role") %>" readonly> <br><br>
        Username: <input type="text" name="aUserName" value="<%= request.getParameter("username") %>" readonly> <br><br>
        Password: <input type="password" name="aPassword" value="<%= request.getParameter("password") %>" readonly> <br><br>
